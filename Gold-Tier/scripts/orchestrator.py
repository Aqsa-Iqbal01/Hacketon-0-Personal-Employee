...
if __name__ == "__main__":
    ...
    # Get the correct vault path - use the script's parent directory
    script_dir = Path(__file__).parent.parent
    vault_path = script_dir / "Personal AI Employee Vault"
    ...
    print(f"📂 Plans: {orchestrator.plans}")
    print(f"📂 Done: {orchestrator.done}")
    print("="*60)
