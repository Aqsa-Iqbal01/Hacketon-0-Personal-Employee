...
if __name__ == "__main__":
    ...
    watch_path = f"{vault_path}\\Inbox"  # Watch the Inbox folder for new files

    watcher = FileSystemWatcher(vault_path, watch_path, check_interval=10)

    print("🚀 File System Watcher started!")
    print(f"📁 Watching: {watch_path}")
    print(f"💾 Files will be copied to: {watcher.needs_action}")
